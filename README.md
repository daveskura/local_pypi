...
pypi-server -p 8080 ./packages -P . -a .
```

## from client pc
```
py -m build
py -m twine upload --repository-url http://localhost:8080 dist/* 

pip install schemawizard-package==2.3.2 --extra-index-url http://localhost:8080
